...
export class Backend implements backendInterface {
    ...
    async addTrendingItem(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addTrendingItem(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteTrendingItem(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteTrendingItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getItemsByCategory(arg0: string): Promise<Array<TrendingItem>> {
        if (this.processError) {
            try {
    ...
    async getTrendingItem(arg0: bigint): Promise<TrendingItem> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrendingItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrendingItems(): Promise<Array<TrendingItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrendingItems();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async likeItem(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.likeItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
